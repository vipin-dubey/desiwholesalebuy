  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white w-full max-w-lg rounded-3xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 bg-gradient-to-br from-emerald-600 via-emerald-700 to-teal-800 text-white text-center relative overflow-hidden">
          ...
          <div className="inline-flex items-center gap-1.5 mt-3 px-3 py-1 rounded-full bg-emerald-500/40 text-emerald-100 text-xs font-bold border border-emerald-300/30">
            <Sparkles className="w-3.5 h-3.5 text-amber-300" />
            <span>You saved {order.totalSavingsNOK} kr on this community delivery!</span>
          </div>
        </div>
        ...
        <div className="p-5 overflow-y-auto space-y-4 text-xs text-slate-700 flex-1">
          ...
          <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200 space-y-2">
            ...
            <div className="flex items-center justify-between text-slate-600">
              ...
              <span className="font-semibold text-slate-800">{order.customer.buildingName}</span>
            </div>
            <div className="flex items-center justify-between text-slate-600">
              <span className="flex items-center gap-1">
        ...
        <div className="p-4 border-t border-slate-100 bg-slate-50 flex gap-2.5">
          <button
            onClick={onClose}
            className="flex-1 py-3 px-4 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs transition-colors cursor-pointer"
          >
            Continue Shopping
          </button>
          <Link
            href="/admin"
            className="py-3 px-4 rounded-xl bg-white border border-slate-300 hover:border-amber-500 text-slate-700 hover:text-amber-700 font-bold text-xs flex items-center justify-center gap-1.5 transition-colors"
          >
